            ...
            <div className="px-4 py-24 mx-auto  sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-64 h-[90vh] flex flex-col justify-center content-center">
              <div className="">
                <div className="w-full max-w-xl mb-12 xl:mb-0 xl:pr-16 xl:w-7/12">
                  <h2 className="max-w-lg mb-6 text-5xl font-semibold tracking-tight text-white md:text-5xl lg:text-6xl xl:text-7xl sm:leading-none bigsect wow fadeInUp">
                    Personal Chef Experience
                  </h2>
                  <p className="max-w-xl mb-4 font-normal text-sm text-white md:text-sm lg:text-base ">
                  ...
                  <div className="flex flex-wrap sm:flex-nowrap wow fadeInUp">
                    <a
                      href="https://wa.me/message/E3A3VLWVVBTSK1"
                      className="relative inline-flex items-center justify-center p-4 px-12 py-4 overflow-hidden font-medium text-white transition duration-300 ease-out border-2 border-white rounded-full shadow-md group"
                    >
