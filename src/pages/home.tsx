            ...
            <div className="px-4 py-24 mx-auto  sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-64 h-[90vh] flex flex-col justify-center content-center">
              <div className="">
                <div className="w-full max-w-xl xl:mb-0 xl:pr-16 xl:w-7/12">
                  <h2 className="max-w-lg mb-6 text-5xl font-semibold tracking-tight text-center text-white sm:text-left md:text-5xl lg:text-6xl xl:text-7xl sm:leading-none bigsect underlined underlined--thin">
                    Personal Chef Experience
                  </h2>
                  {/* <img
                    className="mx-auto mb-6 line lg:mx-0"
                    src="https://i.postimg.cc/ZRdtVH1K/title-line-2.png"
                    alt=""
                  /> */}
                  <p className="max-w-xl mb-4 text-sm font-normal text-center text-white md:text-sm lg:text-base sm:text-left">
