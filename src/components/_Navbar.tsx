...
export default function Navbar() {
  return (
    <nav className="relative shadow-md z-20 flex shrink-0 items-center space-x-2 bg-layer-2 py-6 px-4 sm:px-10">
      ...
      <div className="flex-1">
        <div className="absolute inset-y-0 inset-x-0 hidden items-center justify-center space-x-1.5 px-4 md:flex">
          <NavLink
            to="/about-us"
            className="navlink inline-flex cursor-pointer items-center justify-center font-medium px-4 py-2.5"
          >
            About Us
          </NavLink>
          <NavLink
      ...
      <Menu as="div" className="relative md:hidden">
        <Menu.Button
          type="button"
          className="inline-flex cursor-pointer items-center justify-center font-medium border-none border-transparent bg-transparent p-2 font-medium text-text hover:bg-heading/5 hover:text-heading focus:bg-heading/5 focus:outline-none focus:ring-2 focus:ring-heading/80 focus:ring-offset-0 disabled:opacity-30 disabled:hover:bg-transparent disabled:hover:text-text"
        >
        ...
        >
          <Menu.Items className="absolute right-0 z-50 mt-2 w-56 origin-top-right font-medium bg-white py-3 shadow-xl focus:outline-none">
            <Menu.Item>
              {({ active }) => (
                <NavLink
                  to="/about-us"
